...
typedef struct XR_PROVIDER UnityXRDisplayGraphicsThreadProvider
{
...
typedef struct XR_PROVIDER UnityXRDisplayProvider
{
...
/// @brief XR interface for texture allocation, lifecycle of a frame, blocking for cadence and frame submission.
UNITY_DECLARE_INTERFACE( XR_INTERFACE IUnityXRDisplayInterface )
{
	...
	UnitySubsystemErrorCode( UNITY_INTERFACE_API * XR_REGISTER_PROVIDER( UnityXRDisplayProvider ) RegisterProvider )( UnitySubsystemHandle handle, const UnityXRDisplayProvider * provider );
	...
	/// @return kUnitySubsystemErrorCodeFailure Error
	/// @return kUnitySubsystemErrorCodeInvalidArguments Error
	UnitySubsystemErrorCode( UNITY_INTERFACE_API * XR_REGISTER_PROVIDER( UnityXRDisplayGraphicsThreadProvider ) RegisterProviderForGraphicsThread )( UnitySubsystemHandle handle, const UnityXRDisplayGraphicsThreadProvider * provider );
