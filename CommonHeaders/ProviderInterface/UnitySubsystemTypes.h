...
#define XR_ADAPT_FROM(FUNC_NAME) __attribute__((annotate("adapt_from_" #FUNC_NAME)))
#define XR_REGISTER_PROVIDER(PROVIDER) __attribute__((annotate("register_provider_" #PROVIDER)))
#define XR_ADAPT_IN_PROVIDER_REGISTRATION __attribute__((annotate("in_provider_registration")))
#define UNITY_DECLARE_INTERFACE(NAME) struct NAME
#define UNITY_INTERFACE_API
#else
#define XR_PROVIDER
#define XR_INTERFACE
#define XR_ADAPT_FROM(FUNC_NAME)
#define XR_REGISTER_PROVIDER(PROVIDER)
#define XR_ADAPT_IN_PROVIDER_REGISTRATION
#endif
