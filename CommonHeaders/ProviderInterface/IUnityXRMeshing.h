...
typedef struct XR_PROVIDER UnityXRMeshProvider
{
...
/// @brief XR interface for mesh generation and allocation of related data structures.
UNITY_DECLARE_INTERFACE( XR_INTERFACE IUnityXRMeshInterface )
{
	...
	/// retrieve mesh data.
	UnitySubsystemErrorCode( UNITY_INTERFACE_API * XR_REGISTER_PROVIDER( UnityXRMeshProvider ) RegisterMeshProvider )(
